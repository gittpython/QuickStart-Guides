...
def welcome():
    ...
    print("Let's collect someinfrometion before we start the game.\n")
...
def get_weather():
    # Generate a random temperature between 20 to 90
...
name = prompt("What is the name?", True)
...
running = True
while running:
    # Display the and add  "fancy" text effect
    ...
    advertising = prompt("How muchdo you want to spend on advertising (0 for none)?", False)
